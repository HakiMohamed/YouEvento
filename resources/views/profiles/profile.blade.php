...
<div id="profile" class="mt-20 mb-12 max-h-screen container-xl dark:text-white">
    ...
    <div class="rounded shadow-md bg-[#FFFFFF] dark:bg-[#242526]">
        ...
        <div
            ...
            <div class="gap-2">
                <a href="{{ route('events.user', ['user' => $user->id ]) }}" class="likes-count items-center justify-center flex gap-2"><svg xmlns="http://www.w3.org/2000/svg"
                        width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" class="feather feather-crop">
                        <path d="M6.13 1L6 16a2 2 0 0 0 2 2h15"></path>
                        <path d="M1 6.13L16 6a2 2 0 0 1 2 2v15"></path>
                    </svg>{{ $user->events->count() }} Events</a>
                    
            </div>
            @if($user->id === Auth::id())
            <div class="gap-2">
                <a href="{{ route('user.reservations', ['user' => $user->id ]) }}" class="likes-count items-center justify-center flex gap-2"><i class="fa-regular fa-calendar-check"></i>{{ $CountReservation}} Reservations</a>
